...
namespace EpamCourse.Webdriver.Pages.YandexMail
{
    public class YandexMainPage : PageBase
    {
        ...
        public WebElement UsernameArea = new(isHidden: false, "//div[@class='user-account user-account_has-subname_yes legouser__account i-bem']/span[@class='user-account__name']");
